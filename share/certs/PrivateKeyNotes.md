...
unlocked to sign the MystCoin-Qt.app bundle.
...
allowing somebody to distribute a MystCoin-Qt.app or MystCoin-qt-setup.exe with a valid
...
that the MystCoin-qt.exe file inside the installer had not been tampered with.
